---
title: "Investigate sample FR07961001"
date: "`r Sys.Date()`"
author: "J. Boom"
format:
    html:
        toc: true
        self-contained: true
        toc-title: Table of contents - Investigate sample FR07961001
        toc-location: left
execute:
    echo: true
---
...
FR07961001 <- read_tsv(
    "/mnt/titan/users/j.boom/r-analysis/2024-02-29-combined/FR07961001.general.cancer.subset.2.tsv",
    col_names=TRUE,
...
# Filter out rows that have no annotation scores at all.
#FR07961001.complete <- FR07961001.format |>
#    filter(
#        ! if_all(c(
#            CADD_PHRED,
#            CADD_RAW,
...
THRESHOLDS <- data.frame(
    ...
    CADD_RAW=1.672451,
    CAPICE_SCORE=0.0077,
    FATHMM_MKL_C=0.11054,
    FATHMM_MKL_NC=0.22081
)
```
