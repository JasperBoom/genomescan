...
FR07961000.pca.data <- PCA(FR07961000.nomissing[,1:5],
                           graph=FALSE,
                           ncp=4,
                           scale.unit=TRUE)

# Extract the results for variables.
FR07961000.pca.var <- get_pca_var(FR07961000.pca.data)

# Contributions of variables to PC1.
FR07961000.pc1.contribs <- fviz_contrib(FR07961000.pca.data,
                                        choice="var",
                                        axes=1,
                                        top=10)

# Contributions of variables to PC2.
FR07961000.pc2.contribs <- fviz_contrib(FR07961000.pca.data,
                                        choice="var",
                                        axes=2,
                                        top=10)
```
...
## CAPICE_SCORE.
FR07961000.cp.CAPICE_SCORE <- cutpointr(FR07961000.nomissing,
                                        CAPICE_SCORE,
                                        ClinVar_CLNSIG,
                                        method=maximize_metric,
                                        metric=sum_sens_spec,
...
## FATHMM_MKL_C.
FR07961000.cp.FATHMM_MKL_C <- cutpointr(FR07961000.nomissing,
                                        FATHMM_MKL_C,
                                        ClinVar_CLNSIG,
                                        method=maximize_metric,
                                        metric=sum_sens_spec,
...
## FATHMM_MKL_NC.
FR07961000.cp.FATHMM_MKL_NC <- cutpointr(FR07961000.nomissing,
                                         FATHMM_MKL_NC,
                                         ClinVar_CLNSIG,
                                         method=maximize_metric,
                                         metric=sum_sens_spec,
...
## Combine all tables.
FR07961000.cp.roc.data <- rbind(FR07961000.cp.CADD_PHRED.roc,
